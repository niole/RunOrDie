(function(){
  ...
  var MovingObject = RunOrDie.MovingObject = function (options) {
  ...
  MovingObject.prototype.isCollidedWith = function (otherObject) {
    var centerDist = RunOrDie.Util.dist(this.pos, otherObject.pos);
    return centerDist < (otherObject.rad + this.rad - 2);
  };
